...
String greetingMessage = "{\"id\": 03750944, \"data\": \"AdvTopic Abhay Joshi/03750944 Start Sending\"}";
String endingMessage   = "{\"id\": 03750944, \"data\": \"AdvTopic Abhay Joshi/03750944 End of Sending\"}";
...
//noderedlnxse20220516.o1jkfiv0l98.eu-de.codeengine.appdomain.cloud
    ...
    {
        delay(500);
        Serial.println("Still Connecting to MQTT");        
    }
...
static void send_picture()
{
    ...
    if(true == status)
    {
        String messagePrefix = String("{\"id\": 03750944, \"data\":");
